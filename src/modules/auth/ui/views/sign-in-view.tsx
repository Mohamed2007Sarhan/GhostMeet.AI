...
import { useRouter } from "next/navigation"; // ✅ ملاحظة: هذا هو الصحيح لـ Next.js 13+
    ...
    const onSubmit = async (data: z.infer<typeof formSchema>) => {
        ...
        try {
            ...
            if (error) {
                ...
                setPending(false); // يرجع الزر للعمل
                return;
            }
        ...
        <div className="flex flex-col gap-6 max-w-7xl mx-auto w-full">
            <Card className="overflow-hidden p-0">
                <CardContent className="grid p-0 md:grid-cols-2">
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(onSubmit)} className="p-6 mf:p-8 w-full">
